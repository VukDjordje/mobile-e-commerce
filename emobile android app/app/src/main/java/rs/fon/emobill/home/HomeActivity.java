...
import rs.fon.emobill.home.fragments.CartFragment;
import rs.fon.emobill.home.fragments.CategoryFragment;
import rs.fon.emobill.home.fragments.HomeFragment;
import rs.fon.emobill.home.fragments.MyAccountFragment;
...
public class HomeActivity extends AppCompatActivity {
        ...
        navView.setNavigationItemSelectedListener(new NavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                ...
                if (id == R.id.navHome) {
                    ...
                    Intent ratingsIntent = new Intent(HomeActivity.this, RatingsActivity.class);
    ...
    private void hideSearch() {
        if (currentFragment.getName().equals(HomeFragment.class.getName()) || currentFragment.getName().equals(CategoryFragment.class.getName())) {
            if (optionsMenu != null) {
