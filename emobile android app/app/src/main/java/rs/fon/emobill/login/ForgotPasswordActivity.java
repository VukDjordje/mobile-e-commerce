...
import rs.fon.emobill.databinding.ActivityForgotPasswordBinding;
import rs.fon.emobill.utility.DataValidation;
...
public class ForgotPasswordActivity extends AppCompatActivity{
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        binding.llForgotPass.setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    private void sendPassword() {
        ...
        try {
            String url = "https://emobiletech.000webhostapp.com/api/user/user_forgot_password.php";
