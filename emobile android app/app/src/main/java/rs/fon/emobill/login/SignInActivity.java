...
import rs.fon.emobill.databinding.ActivitySigninBinding;
...
public class SignInActivity extends AppCompatActivity {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        binding.llNewUser.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
    ...
    private void login() {
        if (binding.etEmail.getText().toString().isEmpty() || binding.etPassword.getText().toString().isEmpty()) {
            ...
            if (DataValidation.isValidEmail(binding.etEmail.getText().toString())) {
                try {
                    String url = "https://emobiletech.000webhostapp.com/api/user/user_sign_in.php";
